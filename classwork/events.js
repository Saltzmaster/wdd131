...
function renderTasks(tasks) {
  ...
  const loopTasks = tasks.map(taskTemplate).join('');
  taskList.innerHTML = loopTasks;
}

function newTask() {
  // get the value entered into the #todo input
  const taskItem = document.getElementById('todo').value;

  tasks.push({detail: taskItem, completed: false})
